...
def process_google_play_reports():
    ...
    google_play_reports_dir = "./google-play-reports"
    stats_projects_dir = "./stats/projects"
    stats_total_path = "./stats/total.json"
        ...
        try:
            ...
            for i, col in enumerate(header):
                if 'date' in col.lower():
                    date_idx = i
                elif 'device acquisition' in col.lower() and 'all countries' in col.lower():
